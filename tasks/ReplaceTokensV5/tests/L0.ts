      ...
      runValidation(
        () => {
          ...
          tr.stdout.should.match(
            /{\\"name\\":\\"Microsoft\.ApplicationInsights\.Dev\.\*+\.Event\\",\\"time\\":\\"[^"]+\\",\\"iKey\\":\\"\*+\\",\\"tags\\":{\\"ai\.application\.ver\\":\\"5\.\d+\.\d+\\",\\"ai\.cloud\.role\\":\\"server\\",\\"ai\.internal\.sdkVersion\\":\\"replacetokens:1\.0\.0\\",\\"ai\.operation\.id\\":\\"([^"]+)\\",\\"ai\.operation\.name\\":\\"replacetokens\\",\\"ai\.operation\.parentId\\":\\"\|\1\\",\\"ai\.user\.accountId\\":\\"494d0aad9d06c4ddb51d5300620122ce55366a9382b3cc2835ed5f0e2e67b4d0\\",\\"ai\.user\.authUserId\\":\\"b98ed03d3eec376dcc015365c1a944e3ebbcc33d30e3261af3f4e4abb107aa82\\"},\\"data\\":{\\"baseType\\":\\"EventData\\",\\"baseData\\":{\\"ver\\":\\"2\\",\\"name\\":\\"token\.replaced\\",\\"properties\\":{\\"preview\\":false,\\"pipelineType\\":\\"build\\",\\"result\\":\\"failed\\"}}}}/g
          );
        },
        tr,
        done
    ...
    it('should log summary when replaced', function (done: Mocha.Done) {
      ...
      runValidation(
        () => {
          ...
          tr.stdout.should.include(
            '##vso[task.setvariable variable=tokenReplacedCount;isOutput=false;issecret=false;]8'
          );
          tr.stdout.should.include('##vso[task.setvariable variable=tokenFoundCount;isOutput=false;issecret=false;]8');
          tr.stdout.should.include(
            '##vso[task.setvariable variable=fileProcessedCount;isOutput=false;issecret=false;]2'
          );
          tr.stdout.should.include(
            '##vso[task.setvariable variable=transformExecutedCount;isOutput=false;issecret=false;]2'
          );
          tr.stdout.should.include(
            '##vso[task.setvariable variable=defaultValueCount;isOutput=false;issecret=false;]2'
          );
        },
        tr,
        done
