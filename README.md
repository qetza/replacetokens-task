...
## Usage
Please refer to the dedicated README for the [v3](https://github.com/qetza/replacetokens-task/blob/main/tasks/ReplaceTokensV3/README.md) and [v4](https://github.com/qetza/replacetokens-task/blob/main/tasks/ReplaceTokensV4/README.md) usage.
